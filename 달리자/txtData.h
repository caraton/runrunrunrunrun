...
public:
	...
	void txtSaveExt(const char* saveFileName, vector<string> vStr); //vStr의 정보를 파일에 담아주는 함수 크기 증가
	char* vectorArrayCombineExt(vector<string> vArray);			 //vStr의 정보를 한줄의 문자열로 만들어주는 함수 크기 증가
